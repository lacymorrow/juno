...
#[tauri::command]
pub(crate) async fn type_text(text: String, state: State<'_, AppState>) -> Result<(), String> {
...
#[tauri::command]
pub(crate) async fn press_key(key: String, modifier: Option<String>, state: State<'_, AppState>) -> Result<(), String> {
...
#[tauri::command]
pub(crate) async fn global_type_text(text: String, state: State<'_, AppState>) -> Result<(), String> {
...
#[tauri::command]
pub(crate) async fn hold_key(key: String, duration_ms: Option<u64>, state: State<'_, AppState>) -> Result<(), String> {
...
#[tauri::command]
pub(crate) async fn release_key(key: String, state: State<'_, AppState>) -> Result<(), String> {
