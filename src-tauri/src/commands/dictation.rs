...
pub async fn get_dictation_clipboard_enabled(
    ...
    state
        .set_dictation_clipboard_enabled(audio_settings.dictation_clipboard_enabled)
        .map_err(|e| format!("Failed to set dictation_clipboard_enabled: {}", e))?;

    tracing::debug!(
        "Current Dictation Mode clipboard setting: {}",
        audio_settings.dictation_clipboard_enabled
    );
