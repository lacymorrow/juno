...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            dev_open_url,
            dev_scroll_window,
            // Core Commands - Consolidated with debug features
            get_clipboard,
            set_clipboard,
            wait,
            ...
            dev_left_mouse_down,
            dev_left_mouse_up,
                    // New consolidated mouse commands with debug capabilities
        left_click,
        right_click,
        middle_click,
        double_click,
        ...
        // Original dev commands for backward compatibility
        dev_left_click,
        dev_left_click_drag,
        dev_right_click,
        dev_middle_click,
        dev_double_click,
            ...
            // Shell Commands - Consolidated with debug features
            bash_command,
            // DEPRECATED: Backward compatibility dev_ commands (will be removed)
            dev_bash_command,
            // Window Commands - Consolidated with debug features
            scroll_window,
            get_window_list,
            get_window_info,
            focus_window,
