...
export default function AIProviderSettings({ settings }: SettingsSectionProps) {
  ...
  return (
    <>
      <SettingsGroup
        title="Provider"
        description="Choose the AI provider and model Juno uses"
      >
        <SettingsRow
          htmlFor="ai-provider"
              ...
              <ModelSelectorList>
                ...
                {sortedProviders.map((provider) => (
                  <ModelSelectorGroup
                    ...
                    className={
                      !provider.is_available ? "opacity-50" : undefined
                    }
                  >
          ...
          {selectedModel && (
            <p className="mt-2 text-xs text-muted-foreground">
              {selectedModel.model.supports_computer_use
                ...
                : "This model is for general chat only"}
            </p>
          )}
        </SettingsRow>
      </SettingsGroup>
      ...
      {settings.activeProvider && settings.providerSettings && (
        <SettingsGroup
          title="Configuration"
          description={`Configure settings for ${
        ...
        >
          ...
          <SettingsRow
            ...
            label="System prompt"
            description="Custom instructions prepended to every conversation (optional)"
          >
            <Textarea
              id="system-prompt"
          ...
          <SettingsRow
            ...
            description="Apply your API key and model parameters"
            control={
