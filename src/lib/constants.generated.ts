...
export const MEMORY = {
  LIMITS_DEFAULT_MAX_MESSAGES: 200,
  LIMITS_DEFAULT_MAX_TOKENS: 150000,
  LIMITS_DEFAULT_MIN_MESSAGES_TO_KEEP: 5,
  LIMITS_DEFAULT_SUMMARIZATION_BATCH_SIZE: 40,
  ...
  LIMITS_MAX_SUMMARIES_TO_KEEP: 50,
  LIMITS_HOT_CONTEXT_SIZE: 25,
  LIMITS_EMERGENCY_MIN_KEEP: 3,
  ...
  VISUAL_DEFAULT_SCREENSHOT_RETENTION_SECONDS: 1200,
  VISUAL_DEFAULT_MAX_BASE64_SCREENSHOTS: 5,
  ...
  PERFORMANCE_MAX_CACHE_SIZE: 500,
  PERFORMANCE_DEFAULT_OPERATION_TIMEOUT_MS: 5000,
  PERFORMANCE_MEMORY_OPTIMIZATION_INTERVAL_MS: 120000,
  PERFORMANCE_MAX_LATEST_SUMMARIES_RETURNED: 15,
