...
export const TIMEOUTS = {
  ...
  DEFAULT_NAVIGATION_TIMEOUT_MS: 30,
  REPLICATE_TIMEOUT_SECONDS: 300,
  PERMISSION_CHECK_TIMEOUT_MS: 3,
  AUDIO_DEVICE_DETECTION_TIMEOUT_MS: 3,
  TOOL_EXECUTION_TIMEOUT_MS: 10,
  MCP_INTEGRATION_TIMEOUT_MS: 30,
