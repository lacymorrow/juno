...
export const COMMANDS = {
  ...
  RESET_SETTINGS: 'reset_centralized_settings',
  EXPORT_SETTINGS: 'export_settings',
  IMPORT_SETTINGS: 'import_settings',
  GET_KEYBOARD_SHORTCUTS: 'get_centralized_keyboard_shortcuts',
  SET_KEYBOARD_SHORTCUTS: 'set_centralized_keyboard_shortcuts',
  GET_FLOATING_BAR_SETTINGS: 'get_floating_bar_settings',
  SET_FLOATING_BAR_SETTINGS: 'set_floating_bar_settings',
  GET_AGENT_SETTINGS: 'get_agent_settings',
  SET_AGENT_SETTINGS: 'set_agent_settings',
  GET_PROVIDER_SETTINGS: 'get_centralized_provider_settings',
  SET_PROVIDER_SETTINGS: 'set_centralized_provider_settings',
  GET_CLOUD_SETTINGS: 'get_cloud_settings',
  SET_CLOUD_SETTINGS: 'set_cloud_settings',
  GET_AUDIO_SETTINGS: 'get_audio_settings',
  SET_AUDIO_SETTINGS: 'set_audio_settings',
  GET_TOOL_SETTINGS: 'get_tool_settings',
  SET_TOOL_SETTINGS: 'set_tool_settings',
  GET_ONBOARDING_SETTINGS: 'get_onboarding_settings',
  SET_ONBOARDING_SETTINGS: 'set_onboarding_settings',
  SET_AUTOSTART_ENABLED: 'set_autostart_enabled',
  GET_DEBUG_MODE: 'get_debug_mode',
  SET_DEBUG_MODE: 'set_debug_mode',
  GET_PERFORMANCE_MONITORING: 'get_performance_monitoring',
  SET_PERFORMANCE_MONITORING: 'set_performance_monitoring',
  CANCEL_AGENT_EXECUTION: 'cancel_agent_execution',
  GET_AGENT_EXECUTION_PROGRESS: 'get_agent_execution_progress',
  SET_AGENT_EXECUTION_PROGRESS: 'set_agent_execution_progress',
  GET_SYSTEM_CONTEXT: 'get_system_context',
  SUBMIT_QUERY: 'submit_query',
  GET_AGENT_MODE: 'get_agent_mode',
  SET_AGENT_MODE: 'set_agent_mode',
  GET_AGENT_TRIGGER_MODE: 'get_agent_trigger_mode',
  SET_AGENT_TRIGGER_MODE: 'set_agent_trigger_mode',
  GET_PROVIDERS: 'get_providers',
  GET_ACTIVE_PROVIDER: 'get_active_provider',
  SET_ACTIVE_PROVIDER: 'set_active_provider',
  VALIDATE_PROVIDER_MODEL: 'validate_provider_model',
  GET_PROVIDER_MODELS: 'get_provider_models',
  UPDATE_PROVIDER_API_KEY: 'update_provider_api_key',
  UPDATE_PROVIDER_MODEL: 'update_provider_model',
  UPDATE_PROVIDER_MAX_TOKENS: 'update_provider_max_tokens',
  UPDATE_PROVIDER_TEMPERATURE: 'update_provider_temperature',
  UPDATE_PROVIDER_SYSTEM_PROMPT: 'update_provider_system_prompt',
  START_ALWAYS_LISTENING: 'start_always_listening_mode',
  STOP_ALWAYS_LISTENING: 'stop_always_listening_mode',
  GET_ALWAYS_LISTENING_STATUS: 'get_always_listening_status',
  SET_ALWAYS_LISTENING_SENSITIVITY: 'set_always_listening_sensitivity',
  GET_ALWAYS_LISTENING_SENSITIVITY: 'get_always_listening_sensitivity',
  SET_ALWAYS_LISTENING_WAKE_WORDS: 'set_always_listening_wake_words',
  GET_ALWAYS_LISTENING_WAKE_WORDS: 'get_always_listening_wake_words',
  INVOKE_TTS: 'invoke_tts',
  SET_TTS_PROVIDER: 'set_tts_provider_command',
  GET_TTS_PROVIDER: 'get_tts_provider_command',
  STOP_TTS: 'stop_tts',
  GET_DICTATION_TRIGGER_MODE: 'get_dictation_trigger_mode',
  SET_DICTATION_TRIGGER_MODE: 'set_dictation_trigger_mode',
  GET_DICTATION_CLIPBOARD_ENABLED: 'get_dictation_clipboard_enabled',
  SET_DICTATION_CLIPBOARD_ENABLED: 'set_dictation_clipboard_enabled',
  FORCE_RESET_DICTATION_STATE: 'force_reset_dictation_state',
  GET_DICTATION_COMPREHENSIVE_STATUS: 'get_dictation_comprehensive_status',
  UPDATE_DICTATION_COMPONENT_STATE: 'update_dictation_component_state',
  TRANSITION_DICTATION_STATE: 'transition_dictation_state',
  CHECK_PERMISSIONS_STATUS: 'check_permissions_status_native',
  REQUEST_ACCESSIBILITY_PERMISSION: 'request_accessibility_permission_native',
  REQUEST_MICROPHONE_PERMISSION: 'request_microphone_permission_native',
  REQUEST_SCREEN_RECORDING_PERMISSION: 'request_screen_recording_permission_native',
  REQUEST_INPUT_MONITORING_PERMISSION: 'request_input_monitoring_permission_native',
  TEST_MICROPHONE_FUNCTIONALITY: 'test_microphone_functionality',
  WAIT: 'wait',
  GET_CLIPBOARD: 'get_clipboard',
  SET_CLIPBOARD: 'set_clipboard',
  LIST_APPS: 'list_apps',
  CHECK_SERVER_STATUS: 'check_server_status',
  CAPTURE_SCREENSHOT: 'capture_screenshot_command',
  CAPTURE_ELEMENT_SCREENSHOT: 'capture_element_screenshot_command',
  CAPTURE_WINDOW_SCREENSHOT: 'capture_window_screenshot_command',
  CAPTURE_FOCUSED_WINDOW_SCREENSHOT: 'capture_focused_window_screenshot_command',
} as const;
